...
Feature: New user account registration in ASK
  ...
  Scenario: New user account activation and user account deletion
    ...
    Then MP click on element with xpath "//h5[contains(text(), 'Management')]"
    ...
    Then MP click on element with xpath "//mat-icon[contains(text(), 'delete')]/.." 
    Then MP wait for element with xpath "//span[contains(text(), 'Delete')]/.." to be present
    Then MP wait for 1 sec
    Then MP element with xpath "//div[@class='mat-dialog-content']//p" should contain text "Are you sure you want to delete Hello Student?"
    ...
    Then MP wait for element with xpath "//h3[contains(text(), 'Assessment Control')]" to be present
    Then MP element with xpath "//h3[contains(text(), 'Assessment Control')]" should contain text "Assessment Control"
    Then MP element with xpath "//img[@class='center-logo']" should be displayed
